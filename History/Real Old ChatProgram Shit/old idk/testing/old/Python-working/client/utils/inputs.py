	...
	def waitForMessage(self):
		...
		if "/" in msg:
			if "listClients" in msg:
				...
				print("Command " + msg.replace("/", "") + "not found please type /help for a list of command") # sepereate commands from users with permissions and withut add it to o if not done here
				self.waitForMessage()
