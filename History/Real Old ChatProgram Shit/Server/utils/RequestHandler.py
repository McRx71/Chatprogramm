...
class Clients:#TOD_O:put in own file maybe : clientAdministrationHelper.py?
	...
	def handle(self):
		...
		if self.appendClient:
			...
			for clientInList in fileHelper.readTXTFile("data/", "banList"):
				...
				elif self.client_address[0] + ":" + banTime in clientInList:#FI_XME:decrease banntime overtime
