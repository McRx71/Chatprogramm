...
class server:
	...
	def __init__(self):		
		...
		self._server.bind(("192.168.2.109", 5000))
	...
	#end of helper for class server* 
	...
	def catchConnections(self):
		while True:
			...
			if self.mysqlHelperUtil.isBanned(accepted[1][0]):
				accepted[0].send(bytes("you are banend", "utf-8"))
